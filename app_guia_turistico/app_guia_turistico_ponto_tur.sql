...
--
-- Host: localhost    Database: app_guia_turistico
-- ------------------------------------------------------
...
CREATE TABLE `ponto_tur` (
  ...
  `tipo` enum('Atrativo','Serviço','Equipamento','Infraestrutura','Intituição','Organização') DEFAULT NULL,
...
-- Dump completed on 2024-11-05 20:40:47
